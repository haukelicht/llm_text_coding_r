...
categories <- c("Relevant", "Irrelevant")
...
system_message <- paste0(
  ...
  instruction, "\n",
  "Classify the text into one of the given categories: ", paste(categories, collapse = ", "),
  "\n",
  defintions, 
  "\n",
...
system_message <- paste0(
  ...
  instruction, "\n",
  "Classify each tweet into one of the given categories: ", paste(categories, collapse = ", "), "\n ",
  defintions, 
  "\n",
  "Only include the selected category in your response and no further text. ",
